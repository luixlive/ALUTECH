...
./Sources/HIL/pantallaLCD.o \
./Sources/HIL/sensores.o \

C_DEPS += \
./Sources/HIL/actuadores.d \
./Sources/HIL/pantallaLCD.d \
...
Sources/HIL/pantallaLCD.o: ../Sources/HIL/pantallaLCD.c
	...
	@echo 'Invoking: ARM Ltd Windows GCC C Compiler'
	"$(ARMSourceryDirEnv)/arm-none-eabi-gcc" "$<" @"Sources/HIL/pantallaLCD.args" -MMD -MP -MF"$(@:%.o=%.d)" -o"Sources/HIL/pantallaLCD.o"
	@echo 'Finished building: $<'
	@echo ' '
